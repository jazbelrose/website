...
const handleProjectClick = (project) => {
    if (!localActiveProject || localActiveProject.projectId !== project.projectId) {
    ...
    return (
        <div className='all-projects-container'>
            {projects.map(project => (
                <div key={project.projectId} className="project-container" onClick={() => handleProjectClick(project)}>
